...
HackerMaster es una plataforma web de entrenamiento en ciberseguridad ofensiva basada en retos tipo CTF (Capture The Flag), donde los usuarios trabajan con máquinas vulnerables desplegadas en contenedores Docker.
...
En el desarrollo de HackerMaster se han utilizado las siguientes tecnologías principales:
...
Todas estas tecnologías han sido integradas en un entorno completo de desarrollo y despliegue real.
...
El proyecto me ha permitido construir una aplicación completa orientada a ciberseguridad ofensiva, integrando desarrollo web, Docker y medidas de seguridad reales en una arquitectura funcional.
...
Aunque la plataforma es funcional, todavía tiene margen de evolución hacia un entorno más realista de ciberseguridad ofensiva.
...
Actualmente, el acceso a las máquinas se realiza de forma controlada dentro del entorno de la aplicación. En un entorno más realista, estas máquinas deberían estar aisladas en una red interna accesible únicamente mediante VPN.
